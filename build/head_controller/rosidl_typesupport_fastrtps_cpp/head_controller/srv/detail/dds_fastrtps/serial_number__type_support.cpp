...
#include "head_controller/srv/detail/serial_number__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const head_controller::srv::SerialNumber_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<head_controller::srv::SerialNumber_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SerialNumber_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const head_controller::srv::SerialNumber_Request *>(
...
static size_t _SerialNumber_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SerialNumber_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SerialNumber_Request__callbacks = {
  "head_controller::srv",
...
static rosidl_message_type_support_t _SerialNumber_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SerialNumber_Request__callbacks,
...
{
  return &head_controller::srv::typesupport_fastrtps_cpp::_SerialNumber_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const head_controller::srv::SerialNumber_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<head_controller::srv::SerialNumber_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SerialNumber_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const head_controller::srv::SerialNumber_Response *>(
...
static size_t _SerialNumber_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SerialNumber_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SerialNumber_Response__callbacks = {
  "head_controller::srv",
...
static rosidl_message_type_support_t _SerialNumber_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SerialNumber_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &head_controller::srv::typesupport_fastrtps_cpp::_SerialNumber_Response__handle;
}
...
static service_type_support_callbacks_t _SerialNumber__callbacks = {
  "head_controller::srv",
  "SerialNumber",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, head_controller, srv, SerialNumber_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, head_controller, srv, SerialNumber_Response)(),
...
static rosidl_service_type_support_t _SerialNumber__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SerialNumber__callbacks,
...
{
  return &head_controller::srv::typesupport_fastrtps_cpp::_SerialNumber__handle;
}
