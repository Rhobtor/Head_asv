...
#ifndef HEAD_CONTROLLER__SRV__DETAIL__HEAD__FUNCTIONS_H_
#define HEAD_CONTROLLER__SRV__DETAIL__HEAD__FUNCTIONS_H_
 ...
 * calls
 * head_controller__srv__Head_Request__init().
...
/**
 * It calls
 * head_controller__srv__Head_Request__fini()
 ...
 * head_controller__srv__Head_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * head_controller__srv__Head_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * head_controller__srv__Head_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_head_controller
...
/**
 * It calls
 * head_controller__srv__Head_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_head_controller
...
/**
 * It allocates the memory for the array and calls
 * head_controller__srv__Head_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_head_controller
...
/**
 * It calls
 * head_controller__srv__Head_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HEAD_CONTROLLER__SRV__DETAIL__HEAD__FUNCTIONS_H_
