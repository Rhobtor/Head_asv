...
#include "head_controller/srv/detail/head__rosidl_typesupport_fastrtps_c.h"
...
using _Head_Request__ros_msg_type = head_controller__srv__Head_Request;
...
size_t get_serialized_size_head_controller__srv__Head_Request(
  const void * untyped_ros_message,
...
static uint32_t _Head_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_head_controller__srv__Head_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_head_controller
size_t max_serialized_size_head_controller__srv__Head_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Head_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_head_controller__srv__Head_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, head_controller, srv, Head_Request)() {
...
using _Head_Response__ros_msg_type = head_controller__srv__Head_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_head_controller
size_t get_serialized_size_head_controller__srv__Head_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Head_Response__ros_msg_type * ros_message = static_cast<const _Head_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_head_controller__srv__Head_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_head_controller
size_t max_serialized_size_head_controller__srv__Head_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Head_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_head_controller__srv__Head_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, head_controller, srv, Head_Response)() {
...
// already included above
// #include "head_controller/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "head_controller/srv/head.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, head_controller, srv, Head)() {
  return &Head__handle;
}
