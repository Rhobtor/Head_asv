...
class Metaclass_Head_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('head_controller')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Head(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from head_controller.srv import _head
...
class Head(metaclass=Metaclass_Head):
    from head_controller.srv._head import Head_Request as Request
    from head_controller.srv._head import Head_Response as Response
