...
class HeadServicie(Node):
    def __init__(self):
        ...
        self.declare_parameter('serial_number', "55736313338351E04022")
    ...
    def monitor_usb_port(self):
        while True:
            arduino_ports = [
                ...
                if p.serial_number == self.get_parameter('serial_number').get_parameter_value().string_value #Numero de serie del sonar, cambiar con el que se este utilizando
            ]
