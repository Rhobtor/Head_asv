...
class Metaclass_SerialNumber(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'head_controller.srv.SerialNumber')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from head_controller.srv import _serial_number
...
class SerialNumber(metaclass=Metaclass_SerialNumber):
    from head_controller.srv._serial_number import SerialNumber_Request as Request
    from head_controller.srv._serial_number import SerialNumber_Response as Response
